...
@InnerTestClasses({BlackBoxWithJavaCodegenTestGenerated.Annotations.class, BlackBoxWithJavaCodegenTestGenerated.CallableReference.class, BlackBoxWithJavaCodegenTestGenerated.Constructor.class, BlackBoxWithJavaCodegenTestGenerated.Delegation.class, BlackBoxWithJavaCodegenTestGenerated.Enum.class, BlackBoxWithJavaCodegenTestGenerated.Functions.class, BlackBoxWithJavaCodegenTestGenerated.InnerClass.class, BlackBoxWithJavaCodegenTestGenerated.Property.class, BlackBoxWithJavaCodegenTestGenerated.Reflection.class, BlackBoxWithJavaCodegenTestGenerated.Sam.class, BlackBoxWithJavaCodegenTestGenerated.StaticFun.class, BlackBoxWithJavaCodegenTestGenerated.Visibility.class})
public class BlackBoxWithJavaCodegenTestGenerated extends AbstractBlackBoxCodegenTest {
    ...
    public static class CallableReference extends AbstractBlackBoxCodegenTest {
        ...
        @TestMetadata("fieldJavaClassExtendsKotlin.kt")
        public void testFieldJavaClassExtendsKotlin() throws Exception {
            doTestWithJava("compiler/testData/codegen/boxWithJava/callableReference/fieldJavaClassExtendsKotlin.kt");
        }
    ...
    public static class Reflection extends AbstractBlackBoxCodegenTest {
        public void testAllFilesPresentInReflection() throws Exception {
            JetTestUtils.assertAllTestsPresentByMetadata(this.getClass(), "org.jetbrains.jet.generators.tests.TestsPackage", new File("compiler/testData/codegen/boxWithJava/reflection"), Pattern.compile("^(.+)\\.kt$"), true);
        }
        
        @TestMetadata("mapping.kt")
        public void testMapping() throws Exception {
            doTestWithJava("compiler/testData/codegen/boxWithJava/reflection/mapping.kt");
        }
