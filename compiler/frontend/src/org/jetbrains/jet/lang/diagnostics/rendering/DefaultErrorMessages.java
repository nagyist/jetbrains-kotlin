...
public class DefaultErrorMessages {
    ...
    static {
        ...
        //Inline non Locals
        MAP.put(ONLY_LOCAL_RETURN, "''{0}'' lambda usage in ''{2}'' could support only local returns. Please annotate lambda declaration ''{1}'' with ''inlineOptions(ONLY_LOCAL_RETURN)''", ELEMENT_TEXT, SHORT_NAMES_IN_TYPES, SHORT_NAMES_IN_TYPES);
