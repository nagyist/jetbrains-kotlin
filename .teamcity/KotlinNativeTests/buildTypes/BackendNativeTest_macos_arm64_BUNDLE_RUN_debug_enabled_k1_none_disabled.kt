...
object BackendNativeTest_macos_arm64_BUNDLE_RUN_debug_enabled_k1_none_disabled : BuildType({
    name = "🍏ᵐ Target-Specific Tests (for bundle) opt.debug/st.checker/K1 (Native, Macos aarch64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-g -Xcheck-state-at-external-calls -language-version 1.9")
