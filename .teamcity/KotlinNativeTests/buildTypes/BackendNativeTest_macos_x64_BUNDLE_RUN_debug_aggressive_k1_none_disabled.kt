...
object BackendNativeTest_macos_x64_BUNDLE_RUN_debug_aggressive_k1_none_disabled : BuildType({
    name = "🍎 Target-Specific Tests (for bundle) opt.debug/GC.sch.aggr/K1 (Native, Macos x86_64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-g -Xbinary=gcSchedulerType=aggressive -language-version 1.9")
