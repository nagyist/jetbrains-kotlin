...
object BackendNativeTest_macos_arm64_BUNDLE_RUN_opt_stms_k2_none_enabled : BuildType({
    name = "🍏ᵐ Target-Specific Tests (for bundle) opt.opt/GC.STMS/K2/two-stage (Native, Macos aarch64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-opt -Xbinary=gc=stwms ")
