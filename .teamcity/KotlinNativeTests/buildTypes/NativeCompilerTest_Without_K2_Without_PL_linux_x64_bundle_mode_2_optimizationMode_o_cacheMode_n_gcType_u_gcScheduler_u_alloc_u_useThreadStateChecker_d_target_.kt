...
object NativeCompilerTest_Without_K2_Without_PL_linux_x64_bundle_mode_2_optimizationMode_o_cacheMode_n_gcType_u_gcScheduler_u_alloc_u_useThreadStateChecker_d_target_ : BuildType({
    name = "🐧 Compiler Tests Without K2 Without PL (for bundle) opt.opt/cache.no (Native, Linux x86_64)"
