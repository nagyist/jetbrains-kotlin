...
object NativeCompilerTest_Without_K2_With_PL_linux_arm64_dist_mode_2_optimizationMode_o_cacheMode_n_gcType_u_gcScheduler_u_alloc_u_useThreadStateChecker_d_target_ : BuildType({
    name = "🐧 Compiler Tests Without K2 With PL (for dist) opt.opt/cache.no (Native, Linux ARM64)"
