...
object BackendNativeTest_watchos_simulator_arm64_BUNDLE_RUN_k1_none_disabled : BuildType({
    name = "🍏ᵐ Target-Specific Tests (for bundle) K1 (Native, watchOS-simulator ARM64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-language-version 1.9")
