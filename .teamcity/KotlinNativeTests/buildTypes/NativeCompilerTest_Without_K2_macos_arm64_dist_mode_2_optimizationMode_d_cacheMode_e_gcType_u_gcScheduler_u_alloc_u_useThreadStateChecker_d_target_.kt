...
object NativeCompilerTest_Without_K2_macos_arm64_dist_mode_2_optimizationMode_d_cacheMode_e_gcType_u_gcScheduler_u_alloc_u_useThreadStateChecker_d_target_ : BuildType({
    name = "🍏ᵐ Compiler Tests Without K2 (for dist) opt.debug/cache.* (Native, Macos aarch64)"
