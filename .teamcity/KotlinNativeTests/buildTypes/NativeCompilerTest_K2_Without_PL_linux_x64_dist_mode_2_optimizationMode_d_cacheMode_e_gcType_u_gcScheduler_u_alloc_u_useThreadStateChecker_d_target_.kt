...
object NativeCompilerTest_K2_Without_PL_linux_x64_dist_mode_2_optimizationMode_d_cacheMode_e_gcType_u_gcScheduler_u_alloc_u_useThreadStateChecker_d_target_ : BuildType({
    name = "🐧 Compiler Tests K2 Without PL (for dist) opt.debug/cache.* (Native, Linux x86_64)"
