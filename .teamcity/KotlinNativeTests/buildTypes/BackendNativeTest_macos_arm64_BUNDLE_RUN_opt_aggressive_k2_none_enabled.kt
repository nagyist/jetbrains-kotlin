...
object BackendNativeTest_macos_arm64_BUNDLE_RUN_opt_aggressive_k2_none_enabled : BuildType({
    name = "🍏ᵐ Target-Specific Tests (for bundle) opt.opt/GC.sch.aggr/K2/two-stage (Native, Macos aarch64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-opt -Xbinary=gcSchedulerType=aggressive ")
