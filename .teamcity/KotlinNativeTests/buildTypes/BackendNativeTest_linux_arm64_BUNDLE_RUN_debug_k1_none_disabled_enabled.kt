...
object BackendNativeTest_linux_arm64_BUNDLE_RUN_debug_k1_none_disabled_enabled : BuildType({
    name = "🐧 Target-Specific Tests (for bundle) opt.debug/K1/compile-only (Native, Linux ARM64)"
