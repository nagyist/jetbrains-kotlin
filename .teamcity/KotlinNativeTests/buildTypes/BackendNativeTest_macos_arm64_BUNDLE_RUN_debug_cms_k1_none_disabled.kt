...
object BackendNativeTest_macos_arm64_BUNDLE_RUN_debug_cms_k1_none_disabled : BuildType({
    name = "🍏ᵐ Target-Specific Tests (for bundle) opt.debug/GC.CMS/K1 (Native, Macos aarch64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-g -Xbinary=gc=pmcs -language-version 1.9")
