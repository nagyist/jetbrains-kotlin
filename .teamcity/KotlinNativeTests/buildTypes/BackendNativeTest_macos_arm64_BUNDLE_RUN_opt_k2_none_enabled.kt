...
object BackendNativeTest_macos_arm64_BUNDLE_RUN_opt_k2_none_enabled : BuildType({
    name = "🍏ᵐ Target-Specific Tests (for bundle) opt.opt/K2/two-stage (Native, Macos aarch64)"
