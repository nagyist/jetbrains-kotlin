...
object BackendNativeTest_macos_arm64_BUNDLE_RUN_debug_enabled_aggressive_k2_none_enabled : BuildType({
    name = "🍏ᵐ Target-Specific Tests (for bundle) opt.debug/st.checker/GC.sch.aggr/K2/two-stage (Native, Macos aarch64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-g -Xcheck-state-at-external-calls -Xbinary=gcSchedulerType=aggressive ")
