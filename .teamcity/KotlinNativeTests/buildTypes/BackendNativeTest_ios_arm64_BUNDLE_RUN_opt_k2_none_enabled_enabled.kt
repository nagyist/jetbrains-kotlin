...
object BackendNativeTest_ios_arm64_BUNDLE_RUN_opt_k2_none_enabled_enabled : BuildType({
    name = "🍎 Target-Specific Tests (for bundle) opt.opt/K2/two-stage/compile-only (Native, iOS ARM64)"
