...
object BackendNativeTest_watchos_x64_BUNDLE_RUN_opt_k2_none_enabled : BuildType({
    name = "🍎 Target-Specific Tests (for bundle) opt.opt/K2/two-stage (Native, watchOS X64)"
