...
object NativeCompilerTest_K2_Without_PL_macos_arm64_dist_mode_2_optimizationMode_d_cacheMode_e_gcType_u_gcScheduler_u_alloc_u_useThreadStateChecker_d_target_ : BuildType({
    name = "🍏ᵐ Compiler Tests K2 Without PL (for dist) opt.debug/cache.* (Native, Macos aarch64)"
