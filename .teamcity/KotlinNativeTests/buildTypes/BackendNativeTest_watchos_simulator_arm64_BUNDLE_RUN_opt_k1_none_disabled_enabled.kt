...
object BackendNativeTest_watchos_simulator_arm64_BUNDLE_RUN_opt_k1_none_disabled_enabled : BuildType({
    name = "🍏ᵐ Target-Specific Tests (for bundle) opt.opt/K1/compile-only (Native, watchOS-simulator ARM64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-opt -language-version 1.9")
