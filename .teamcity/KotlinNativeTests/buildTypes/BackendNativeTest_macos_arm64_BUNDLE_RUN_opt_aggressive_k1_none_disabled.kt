...
object BackendNativeTest_macos_arm64_BUNDLE_RUN_opt_aggressive_k1_none_disabled : BuildType({
    name = "🍏ᵐ Target-Specific Tests (for bundle) opt.opt/GC.sch.aggr/K1 (Native, Macos aarch64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-opt -Xbinary=gcSchedulerType=aggressive -language-version 1.9")
