...
object BackendNativeTest_watchos_arm64_BUNDLE_RUN_debug_k1_none_disabled_enabled : BuildType({
    name = "🍏ᵐ Target-Specific Tests (for bundle) opt.debug/K1/compile-only (Native, watchOS ARM64)"
