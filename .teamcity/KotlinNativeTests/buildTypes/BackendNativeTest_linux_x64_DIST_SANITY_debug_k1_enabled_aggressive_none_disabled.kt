...
object BackendNativeTest_linux_x64_DIST_SANITY_debug_k1_enabled_aggressive_none_disabled : BuildType({
    name = "🐧 Target-Specific Tests (for dist) opt.debug/K1/st.checker/GC.sch.aggr (Native, Linux x86_64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-g -language-version 1.9 -Xcheck-state-at-external-calls -Xbinary=gcSchedulerType=aggressive")
