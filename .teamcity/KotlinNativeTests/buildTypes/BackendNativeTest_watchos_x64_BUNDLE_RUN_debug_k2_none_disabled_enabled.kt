...
object BackendNativeTest_watchos_x64_BUNDLE_RUN_debug_k2_none_disabled_enabled : BuildType({
    name = "🍏ᵐ Target-Specific Tests (for bundle) opt.debug/K2/compile-only (Native, watchOS X64)"
