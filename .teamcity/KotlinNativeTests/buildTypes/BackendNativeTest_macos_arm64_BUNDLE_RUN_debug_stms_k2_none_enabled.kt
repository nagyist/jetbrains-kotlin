...
object BackendNativeTest_macos_arm64_BUNDLE_RUN_debug_stms_k2_none_enabled : BuildType({
    name = "🍏ᵐ Target-Specific Tests (for bundle) opt.debug/GC.STMS/K2/two-stage (Native, Macos aarch64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-g -Xbinary=gc=stwms ")
