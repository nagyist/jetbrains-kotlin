...
object BackendNativeTest_macos_arm64_BUNDLE_RUN_debug_mimalloc_k1_none_enabled : BuildType({
    name = "🍏ᵐ Target-Specific Tests (for bundle) opt.debug/alloc.mimalloc/K1/two-stage (Native, Macos aarch64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-g -Xallocator=mimalloc -language-version 1.9")
