...
object BackendNativeTest_macos_x64_BUNDLE_RUN_debug_aggressive_k2_none_enabled : BuildType({
    name = "🍎 Target-Specific Tests (for bundle) opt.debug/GC.sch.aggr/K2/two-stage (Native, Macos x86_64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-g -Xbinary=gcSchedulerType=aggressive ")
