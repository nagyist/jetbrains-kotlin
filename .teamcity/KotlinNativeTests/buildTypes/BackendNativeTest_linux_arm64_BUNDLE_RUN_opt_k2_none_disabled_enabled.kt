...
object BackendNativeTest_linux_arm64_BUNDLE_RUN_opt_k2_none_disabled_enabled : BuildType({
    name = "🐧 Target-Specific Tests (for bundle) opt.opt/K2/compile-only (Native, Linux ARM64)"
