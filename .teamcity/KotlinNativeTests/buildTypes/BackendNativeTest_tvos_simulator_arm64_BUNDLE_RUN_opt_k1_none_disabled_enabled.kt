...
object BackendNativeTest_tvos_simulator_arm64_BUNDLE_RUN_opt_k1_none_disabled_enabled : BuildType({
    name = "🍏ᵐ Target-Specific Tests (for bundle) opt.opt/K1/compile-only (Native, tvOS-simulator ARM64)"
