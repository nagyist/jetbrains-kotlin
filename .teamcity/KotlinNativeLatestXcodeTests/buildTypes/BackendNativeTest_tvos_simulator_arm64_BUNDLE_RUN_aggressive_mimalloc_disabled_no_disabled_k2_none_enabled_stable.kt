...
object BackendNativeTest_tvos_simulator_arm64_BUNDLE_RUN_aggressive_mimalloc_disabled_no_disabled_k2_none_enabled_stable : BuildType({
    name = "🍏ᵐ [Xcode Stable] Target-Specific Tests (for bundle) GC.sch.aggr/alloc.mimalloc/K2/two-stage (Native, tvOS-simulator ARM64)"
