...
object BackendNativeTest_watchos_simulator_arm64_BUNDLE_RUN_stms_mimalloc_disabled_opt_disabled_k2_none_enabled_beta : BuildType({
    name = "🍏ᵐ [Xcode Beta] Target-Specific Tests (for bundle) GC.STMS/alloc.mimalloc/opt.opt/K2/two-stage (Native, watchOS-simulator ARM64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-Xbinary=gc=stwms -Xallocator=mimalloc  -opt  ")
