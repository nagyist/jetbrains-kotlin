...
object BackendNativeTest_tvos_simulator_arm64_BUNDLE_RUN_stms_aggressive_disabled_no_disabled_k2_none_enabled_beta : BuildType({
    name = "🍏ᵐ [Xcode Beta] Target-Specific Tests (for bundle) GC.STMS/GC.sch.aggr/K2/two-stage (Native, tvOS-simulator ARM64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-Xbinary=gc=stwms -Xbinary=gcSchedulerType=aggressive    ")
