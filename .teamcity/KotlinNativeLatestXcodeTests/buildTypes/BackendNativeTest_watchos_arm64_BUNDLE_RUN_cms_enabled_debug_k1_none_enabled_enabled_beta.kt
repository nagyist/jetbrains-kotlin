...
object BackendNativeTest_watchos_arm64_BUNDLE_RUN_cms_enabled_debug_k1_none_enabled_enabled_beta : BuildType({
    name = "🍏ᵐ [Xcode Beta] Target-Specific Tests (for bundle) GC.CMS/st.checker/opt.debug/K1/two-stage/compile-only (Native, watchOS ARM64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-Xbinary=gc=pmcs -Xcheck-state-at-external-calls -g -language-version 1.9")
