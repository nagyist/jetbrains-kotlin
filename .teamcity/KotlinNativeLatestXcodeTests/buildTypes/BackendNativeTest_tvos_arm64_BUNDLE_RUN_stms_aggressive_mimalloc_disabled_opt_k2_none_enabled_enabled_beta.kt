...
object BackendNativeTest_tvos_arm64_BUNDLE_RUN_stms_aggressive_mimalloc_disabled_opt_k2_none_enabled_enabled_beta : BuildType({
    name = "🍏ᵐ [Xcode Beta] Target-Specific Tests (for bundle) GC.STMS/GC.sch.aggr/alloc.mimalloc/opt.opt/K2/two-stage/compile-only (Native, tvOS ARM64)"
    ...
    params {
        param("kotlin.native.test_compile_only", "-Ptest_compile_only")
        ...
        param("kotlin.native.test_flags", "-Xbinary=gc=stwms -Xbinary=gcSchedulerType=aggressive -Xallocator=mimalloc  -opt ")
    ...
    requirements {
        ...
        startsWith("teamcity.agent.name", "titan-kotlin-k8s-native-xcode-beta-macos")
