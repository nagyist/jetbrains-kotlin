...
object BackendNativeTest_ios_simulator_arm64_BUNDLE_RUN_stms_aggressive_mimalloc_disabled_opt_disabled_k2_none_enabled_beta : BuildType({
    name = "🍏ᵐ [Xcode Beta] Target-Specific Tests (for bundle) GC.STMS/GC.sch.aggr/alloc.mimalloc/opt.opt/K2/two-stage (Native, iOS-simulator ARM64)"
