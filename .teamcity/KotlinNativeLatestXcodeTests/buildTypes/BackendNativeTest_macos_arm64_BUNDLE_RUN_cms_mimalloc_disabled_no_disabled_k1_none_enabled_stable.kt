...
object BackendNativeTest_macos_arm64_BUNDLE_RUN_cms_mimalloc_disabled_no_disabled_k1_none_enabled_stable : BuildType({
    name = "🍏ᵐ [Xcode Stable] Target-Specific Tests (for bundle) GC.CMS/alloc.mimalloc/K1/two-stage (Native, Macos aarch64)"
