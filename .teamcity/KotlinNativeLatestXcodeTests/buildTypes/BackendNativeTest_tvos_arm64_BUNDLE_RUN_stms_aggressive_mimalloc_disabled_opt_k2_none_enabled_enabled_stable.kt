...
object BackendNativeTest_tvos_arm64_BUNDLE_RUN_stms_aggressive_mimalloc_disabled_opt_k2_none_enabled_enabled_stable : BuildType({
    name = "🍏ᵐ [Xcode Stable] Target-Specific Tests (for bundle) GC.STMS/GC.sch.aggr/alloc.mimalloc/opt.opt/K2/two-stage/compile-only (Native, tvOS ARM64)"
