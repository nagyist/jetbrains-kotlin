...
object BackendNativeTest_tvos_simulator_arm64_BUNDLE_RUN_aggressive_mimalloc_disabled_no_disabled_k2_none_enabled_beta : BuildType({
    name = "🍏ᵐ [Xcode Beta] Target-Specific Tests (for bundle) GC.sch.aggr/alloc.mimalloc/K2/two-stage (Native, tvOS-simulator ARM64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-Xbinary=gcSchedulerType=aggressive -Xallocator=mimalloc    ")
