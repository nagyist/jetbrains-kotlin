...
object BackendNativeTest_macos_arm64_BUNDLE_RUN_cms_aggressive_mimalloc_enabled_debug_disabled_k2_none_enabled_beta : BuildType({
    name = "🍏ᵐ [Xcode Beta] Target-Specific Tests (for bundle) GC.CMS/GC.sch.aggr/alloc.mimalloc/st.checker/opt.debug/K2/two-stage (Native, Macos aarch64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-Xbinary=gc=pmcs -Xbinary=gcSchedulerType=aggressive -Xallocator=mimalloc -Xcheck-state-at-external-calls -g  ")
