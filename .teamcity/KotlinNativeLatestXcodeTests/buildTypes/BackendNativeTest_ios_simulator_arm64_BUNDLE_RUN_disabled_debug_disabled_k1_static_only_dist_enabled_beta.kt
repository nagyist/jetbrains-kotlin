...
object BackendNativeTest_ios_simulator_arm64_BUNDLE_RUN_disabled_debug_disabled_k1_static_only_dist_enabled_beta : BuildType({
    name = "🍏ᵐ [Xcode Beta] Target-Specific Tests (for bundle) opt.debug/K1/cache.dist/two-stage (Native, iOS-simulator ARM64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", " -g  -language-version 1.9")
