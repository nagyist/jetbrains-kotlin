...
object BackendNativeTest_ios_arm64_BUNDLE_RUN_debug_k2_static_everywhere_enabled_enabled_stable : BuildType({
    name = "🍏ᵐ [Xcode Stable] Target-Specific Tests (for bundle) opt.debug/K2/cache.*/two-stage/compile-only (Native, iOS ARM64)"
