...
object BackendNativeTest_ios_simulator_arm64_BUNDLE_RUN_noop_aggressive_mimalloc_disabled_no_disabled_k2_none_enabled_stable : BuildType({
    name = "🍏ᵐ [Xcode Stable] Target-Specific Tests (for bundle) GC.no-op/GC.sch.aggr/alloc.mimalloc/K2/two-stage (Native, iOS-simulator ARM64)"
