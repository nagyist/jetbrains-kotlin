...
object BackendNativeTest_ios_arm64_BUNDLE_RUN_debug_k2_static_everywhere_enabled_enabled_beta : BuildType({
    name = "🍏ᵐ [Xcode Beta] Target-Specific Tests (for bundle) opt.debug/K2/cache.*/two-stage/compile-only (Native, iOS ARM64)"
    ...
    params {
        ...
        param("kotlin.native.test_cache", "-Ptest_with_cache_kind=static_everywhere")
        ...
        param("kotlin.native.test_flags", "-g ")
