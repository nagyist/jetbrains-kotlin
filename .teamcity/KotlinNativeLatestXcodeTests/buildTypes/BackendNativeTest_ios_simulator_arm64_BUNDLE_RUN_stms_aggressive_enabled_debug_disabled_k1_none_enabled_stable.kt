...
object BackendNativeTest_ios_simulator_arm64_BUNDLE_RUN_stms_aggressive_enabled_debug_disabled_k1_none_enabled_stable : BuildType({
    name = "🍏ᵐ [Xcode Stable] Target-Specific Tests (for bundle) GC.STMS/GC.sch.aggr/st.checker/opt.debug/K1/two-stage (Native, iOS-simulator ARM64)"
