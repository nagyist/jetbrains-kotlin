...
object BackendNativeTest_tvos_simulator_arm64_BUNDLE_RUN_noop_mimalloc_enabled_debug_disabled_k2_none_enabled_stable : BuildType({
    name = "🍏ᵐ [Xcode Stable] Target-Specific Tests (for bundle) GC.no-op/alloc.mimalloc/st.checker/opt.debug/K2/two-stage (Native, tvOS-simulator ARM64)"
