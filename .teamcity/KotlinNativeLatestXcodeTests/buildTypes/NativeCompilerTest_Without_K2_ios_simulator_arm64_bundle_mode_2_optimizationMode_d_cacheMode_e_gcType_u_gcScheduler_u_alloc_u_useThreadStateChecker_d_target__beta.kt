...
object NativeCompilerTest_Without_K2_ios_simulator_arm64_bundle_mode_2_optimizationMode_d_cacheMode_e_gcType_u_gcScheduler_u_alloc_u_useThreadStateChecker_d_target__beta : BuildType({
    name = "🍏ᵐ [Xcode Beta] Compiler Tests Without K2 (for bundle) opt.debug/cache.* (Native, iOS-simulator ARM64)"
