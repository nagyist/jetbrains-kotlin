...
object BackendNativeTest_macos_arm64_BUNDLE_RUN_disabled_debug_disabled_k1_static_only_dist_enabled_stable : BuildType({
    name = "🍏ᵐ [Xcode Stable] Target-Specific Tests (for bundle) opt.debug/K1/cache.dist/two-stage (Native, Macos aarch64)"
