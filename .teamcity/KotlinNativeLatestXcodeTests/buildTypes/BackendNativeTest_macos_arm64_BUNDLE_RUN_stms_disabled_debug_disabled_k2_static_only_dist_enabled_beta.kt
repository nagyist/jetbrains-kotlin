...
object BackendNativeTest_macos_arm64_BUNDLE_RUN_stms_disabled_debug_disabled_k2_static_only_dist_enabled_beta : BuildType({
    name = "🍏ᵐ [Xcode Beta] Target-Specific Tests (for bundle) GC.STMS/opt.debug/K2/cache.dist/two-stage (Native, Macos aarch64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-Xbinary=gc=stwms  -g  ")
