...
object BackendNativeTest_watchos_simulator_arm64_BUNDLE_RUN_stms_mimalloc_disabled_opt_disabled_k2_none_enabled_stable : BuildType({
    name = "🍏ᵐ [Xcode Stable] Target-Specific Tests (for bundle) GC.STMS/alloc.mimalloc/opt.opt/K2/two-stage (Native, watchOS-simulator ARM64)"
