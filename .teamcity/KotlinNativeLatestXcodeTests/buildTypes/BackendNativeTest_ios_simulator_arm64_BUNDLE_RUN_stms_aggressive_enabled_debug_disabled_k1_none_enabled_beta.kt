...
object BackendNativeTest_ios_simulator_arm64_BUNDLE_RUN_stms_aggressive_enabled_debug_disabled_k1_none_enabled_beta : BuildType({
    name = "🍏ᵐ [Xcode Beta] Target-Specific Tests (for bundle) GC.STMS/GC.sch.aggr/st.checker/opt.debug/K1/two-stage (Native, iOS-simulator ARM64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-Xbinary=gc=stwms -Xbinary=gcSchedulerType=aggressive -Xcheck-state-at-external-calls -g  -language-version 1.9")
