...
object BackendNativeTest_watchos_simulator_arm64_BUNDLE_RUN_enabled_debug_disabled_k2_none_enabled_beta : BuildType({
    name = "🍏ᵐ [Xcode Beta] Target-Specific Tests (for bundle) st.checker/opt.debug/K2/two-stage (Native, watchOS-simulator ARM64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-Xcheck-state-at-external-calls -g  ")
