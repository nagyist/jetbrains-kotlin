...
object BackendNativeTest_tvos_simulator_arm64_BUNDLE_RUN_cms_aggressive_disabled_opt_disabled_k1_none_enabled_stable : BuildType({
    name = "🍏ᵐ [Xcode Stable] Target-Specific Tests (for bundle) GC.CMS/GC.sch.aggr/opt.opt/K1/two-stage (Native, tvOS-simulator ARM64)"
