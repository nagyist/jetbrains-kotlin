...
object BackendNativeTest_watchos_simulator_arm64_BUNDLE_RUN_cms_aggressive_disabled_no_disabled_k1_none_enabled_beta : BuildType({
    name = "🍏ᵐ [Xcode Beta] Target-Specific Tests (for bundle) GC.CMS/GC.sch.aggr/K1/two-stage (Native, watchOS-simulator ARM64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-Xbinary=gc=pmcs -Xbinary=gcSchedulerType=aggressive    -language-version 1.9")
