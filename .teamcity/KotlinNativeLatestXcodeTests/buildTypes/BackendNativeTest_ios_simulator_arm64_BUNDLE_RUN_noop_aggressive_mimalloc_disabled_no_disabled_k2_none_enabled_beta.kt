...
object BackendNativeTest_ios_simulator_arm64_BUNDLE_RUN_noop_aggressive_mimalloc_disabled_no_disabled_k2_none_enabled_beta : BuildType({
    name = "🍏ᵐ [Xcode Beta] Target-Specific Tests (for bundle) GC.no-op/GC.sch.aggr/alloc.mimalloc/K2/two-stage (Native, iOS-simulator ARM64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-Xbinary=gc=noop -Xbinary=gcSchedulerType=aggressive -Xallocator=mimalloc    ")
