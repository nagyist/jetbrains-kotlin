...
object BackendNativeTest_ios_simulator_arm64_BUNDLE_RUN_cms_disabled_debug_disabled_k2_static_only_dist_enabled_beta : BuildType({
    name = "🍏ᵐ [Xcode Beta] Target-Specific Tests (for bundle) GC.CMS/opt.debug/K2/cache.dist/two-stage (Native, iOS-simulator ARM64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-Xbinary=gc=pmcs  -g  ")
