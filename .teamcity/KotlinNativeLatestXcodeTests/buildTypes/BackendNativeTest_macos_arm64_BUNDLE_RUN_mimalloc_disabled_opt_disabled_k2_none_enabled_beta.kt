...
object BackendNativeTest_macos_arm64_BUNDLE_RUN_mimalloc_disabled_opt_disabled_k2_none_enabled_beta : BuildType({
    name = "🍏ᵐ [Xcode Beta] Target-Specific Tests (for bundle) alloc.mimalloc/opt.opt/K2/two-stage (Native, Macos aarch64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-Xallocator=mimalloc  -opt  ")
