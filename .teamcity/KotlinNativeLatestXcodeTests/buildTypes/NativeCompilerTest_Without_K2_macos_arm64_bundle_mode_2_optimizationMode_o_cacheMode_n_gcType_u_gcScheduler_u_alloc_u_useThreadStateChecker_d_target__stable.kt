...
object NativeCompilerTest_Without_K2_macos_arm64_bundle_mode_2_optimizationMode_o_cacheMode_n_gcType_u_gcScheduler_u_alloc_u_useThreadStateChecker_d_target__stable : BuildType({
    name = "🍏ᵐ [Xcode Stable] Compiler Tests Without K2 (for bundle) opt.opt/cache.no (Native, Macos aarch64)"
