...
object BackendNativeTest_watchos_arm64_BUNDLE_RUN_cms_enabled_debug_k1_none_enabled_enabled_stable : BuildType({
    name = "🍏ᵐ [Xcode Stable] Target-Specific Tests (for bundle) GC.CMS/st.checker/opt.debug/K1/two-stage/compile-only (Native, watchOS ARM64)"
