...
object BackendNativeTest_macos_arm64_BUNDLE_RUN_cms_mimalloc_disabled_no_disabled_k1_none_enabled_beta : BuildType({
    name = "🍏ᵐ [Xcode Beta] Target-Specific Tests (for bundle) GC.CMS/alloc.mimalloc/K1/two-stage (Native, Macos aarch64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-Xbinary=gc=pmcs -Xallocator=mimalloc    -language-version 1.9")
