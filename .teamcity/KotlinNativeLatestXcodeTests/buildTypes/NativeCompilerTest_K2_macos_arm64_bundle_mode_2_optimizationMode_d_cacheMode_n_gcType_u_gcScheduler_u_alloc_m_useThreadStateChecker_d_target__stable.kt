...
object NativeCompilerTest_K2_macos_arm64_bundle_mode_2_optimizationMode_d_cacheMode_n_gcType_u_gcScheduler_u_alloc_m_useThreadStateChecker_d_target__stable : BuildType({
    name = "🍏ᵐ [Xcode Stable] Compiler Tests K2 (for bundle) opt.debug/cache.no/alloc.mimalloc (Native, Macos aarch64)"
