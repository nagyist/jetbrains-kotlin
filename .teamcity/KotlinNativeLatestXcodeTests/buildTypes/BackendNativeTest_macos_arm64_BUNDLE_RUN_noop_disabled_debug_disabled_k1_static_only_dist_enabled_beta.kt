...
object BackendNativeTest_macos_arm64_BUNDLE_RUN_noop_disabled_debug_disabled_k1_static_only_dist_enabled_beta : BuildType({
    name = "🍏ᵐ [Xcode Beta] Target-Specific Tests (for bundle) GC.no-op/opt.debug/K1/cache.dist/two-stage (Native, Macos aarch64)"
    ...
    params {
        ...
        param("kotlin.native.test_cache", "-Ptest_with_cache_kind=static")
        ...
        param("kotlin.native.test_flags", "-Xbinary=gc=noop  -g  -language-version 1.9")
