...
object BackendNativeTest_tvos_simulator_arm64_BUNDLE_RUN_noop_mimalloc_enabled_debug_disabled_k2_none_enabled_beta : BuildType({
    name = "🍏ᵐ [Xcode Beta] Target-Specific Tests (for bundle) GC.no-op/alloc.mimalloc/st.checker/opt.debug/K2/two-stage (Native, tvOS-simulator ARM64)"
    ...
    params {
        ...
        param("kotlin.native.test_flags", "-Xbinary=gc=noop -Xallocator=mimalloc -Xcheck-state-at-external-calls -g  ")
