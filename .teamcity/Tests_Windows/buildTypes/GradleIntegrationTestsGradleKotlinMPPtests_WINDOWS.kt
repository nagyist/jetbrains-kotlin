...
object GradleIntegrationTestsGradleKotlinMPPtests_WINDOWS : BuildType({
    name = "🪟 Gradle Integration Tests Gradle Kotlin MPP tests (Windows)"
    ...
    steps {
        ...
        gradle {
            ...
            tasks = ":kotlin-gradle-plugin-integration-tests:kgpMppTests"
            buildFile = "build.gradle.kts"
            workingDir = "%teamcity.build.checkoutDir%/kotlin"
    ...
    dependencies {
        ...
        dependency(KotlinNative.buildTypes.KotlinNativeDist_mingw_x64_BUNDLE) {
            ...
            artifacts {
                ...
                artifactRules = """
                    +:kotlin-native-windows-x86_64-${BuildNumber.depParamRefs.buildNumber}.zip!** => %teamcity.build.checkoutDir%/kotlin/.kotlin/konan-for-gradle-tests
                    +:kotlin-native-prebuilt-windows-x86_64-${BuildNumber.depParamRefs.buildNumber}.zip!** => %teamcity.build.checkoutDir%/kotlin/.kotlin/konan-for-gradle-tests
                """.trimIndent()
            }
        }
    }
