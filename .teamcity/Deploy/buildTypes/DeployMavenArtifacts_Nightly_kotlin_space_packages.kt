    ...
    steps {
        script {
            ...
            scriptContent = """
                ...
                -d '
                <build>
                    <buildType id="Kotlin_BuildPlayground_Titan_Aggregate_user_projects_Nightly"/>
                    <properties>
                        <property name="reverse.dep.*.kotlin_snapshot_version" value="%DeployVersion%"/>
                    </properties>
                </build>'
                
                curl -X PUT https://buildserver.labs.intellij.net/app/rest/buildTypes/Kotlin_BuildPlayground_Titan_Aggregate_user_projects_Nightly/parameters/reverse.dep.*.kotlin_snapshot_version \
