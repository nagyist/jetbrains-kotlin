...
object RelayNightlyDevToSonatype : BuildType({
    ...
    params {
        password("space-password", "credentialsJSON:909b7ec4-7b0b-4868-ac5c-637a8fb9dbfe", display = ParameterDisplay.PROMPT)
        ...
        text("version", "${BuildNumber.depParamRefs["deployVersion"]}", display = ParameterDisplay.PROMPT, allowEmpty = false)
        ...
        param("sonatype-repository-description", "Publishing %version% from %space-url% %space-project-key% %space-repo-name%")
