...
object atomicfu : BuildType({
    ...
    steps {
        gradle {
            ...
            gradleParams = "--stacktrace -Pkotlin_repo_url=https://maven.pkg.jetbrains.space/kotlin/p/kotlin/dev --info --continue -Pkotlin_version=%system.kotlin_snapshot_version%"
