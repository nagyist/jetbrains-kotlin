...
import KotlinNativePerformanceTests.vcsRoots.*
...
object Project : Project({
    ...
    vcsRoot(SpaceVCS)
    vcsRoot(Kotlinx_Atomicfu)

    buildType(KotlinNativePerformance_Tests_Debug_macos_x64)
    buildType(KotlinNativePerformance_Tests_Debug_macos_arm64)
    buildType(KotlinNativeSpace_iOS_Performance_ios_arm64)
    buildType(KotlinNativeLibraries_Compilation_Performance_linux_x64)
