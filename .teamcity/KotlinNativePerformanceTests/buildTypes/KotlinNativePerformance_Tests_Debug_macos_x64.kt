    ...
    steps {
        ...
        gradle {
            ...
            gradleParams = """
                %gradleParameters% --parallel -Pbuild.number=%kotlin.native.version%
                -PkonanMetaVersion=%konanMetaVersion%
                -PkonanVersion=%konanVersion% -Pkotlin.native.home=%kotlin.native.test_dist% -Pkotlin.native.enabled=true -i -Pkotlin.native.performance.server.url=%kotlin.native.performance.server.url% -Pkotlin.bundleBuild -PbuildNumberSuffix=DebugNewMM
            """.trimIndent()
            gradleWrapperPath = "../.."
            enableStacktrace = false
        }
