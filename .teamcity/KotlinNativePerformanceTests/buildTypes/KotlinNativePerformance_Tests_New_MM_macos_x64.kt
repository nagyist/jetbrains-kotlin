    ...
    steps {
        ...
        gradle {
            ...
            gradleParams = """
                ...
                -PkonanVersion=%konanVersion% -Pkotlin.native.home=%kotlin.native.test_dist% -Pkotlin.native.enabled=true -i -Pkotlin.native.performance.server.url=%kotlin.native.performance.server.url% -Pkotlin.bundleBuild -Pkotlin_root=../..
            """.trimIndent()
            gradleWrapperPath = "../.."
        ...
        gradle {
            ...
            gradleParams = """
                ...
                -PkonanMetaVersion=%konanMetaVersion%
                -PkonanVersion=%konanVersion% -Pkotlin.native.home=%kotlin.native.test_dist% -Pkotlin.native.enabled=true -i -Pkotlin.native.performance.server.url=%kotlin.native.performance.server.url% -Pkotlin.bundleBuild
            """.trimIndent()
            gradleWrapperPath = "../.."
            enableStacktrace = false
        }
        gradle {
            ...
            gradleParams = """
                %gradleParameters% --parallel -Pbuild.number=%kotlin.native.version%
                -PkonanMetaVersion=%konanMetaVersion%
                -PkonanVersion=%konanVersion% -Pkotlin.native.home=%kotlin.native.test_dist% -Pkotlin.native.enabled=true -i -Pkotlin.native.performance.server.url=%kotlin.native.performance.server.url% -Pkotlin.bundleBuild -PbuildNumberSuffix=NewMM
            """.trimIndent()
            gradleWrapperPath = "../.."
            enableStacktrace = false
        }
