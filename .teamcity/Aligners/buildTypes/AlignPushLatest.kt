...
object AlignPushLatest : BuildType({
    ...
    params {
        param("correspondent_commit", "Correspondent commit to diverge commit in Kotlin for `IntelliJ Monorepo For Kotlin Collaboration kt-master` in `kt-master` branch (will be set during execution)")
