...
object SynchronizeMutedTestsLINUX : BuildType({
    ...
    steps {
        gradle {
            ...
            gradleParams = "%gradleParameters% --parallel -Porg.jetbrains.kotlin.test.mutes.tests.project.id=Kotlin_BuildPlayground_Titan_Tests_Linux -Porg.jetbrains.kotlin.test.mutes.teamcity.server.url=%teamcity.serverUrl% -Porg.jetbrains.kotlin.test.mutes.teamcity.server.token=%user.token%"
