...
object Aggregate : BuildType({
    name = "Aggregate"
    description = "Run build with the aligner in https://buildserver.labs.intellij.net/buildConfiguration/Kotlin_BuildPlayground_Titan_MainAggregateAligner"
    ...
    dependencies {
        ...
        snapshot(Tests_Linux.buildTypes.BenchmarkCompilationCheckK1) {
        }
        ...
        snapshot(Tests_Linux.buildTypes.GradleIntegrationTestsMPPAndroidNative_LINUX) {
        }
        snapshot(Tests_Linux.buildTypes.GradleIntegrationTestsMPPAndroidNativewithLatestGradle_LINUX) {
        }
        ...
        snapshot(Tests_Linux.buildTypes.SerializationCompilationCheckK1) {
        }
        ...
        snapshot(AbsoluteId("ijplatform_master_KotlinDebuggerTestsLatestCompiler_master")) {
        }
