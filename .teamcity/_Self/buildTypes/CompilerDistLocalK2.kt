...
object CompilerDistLocalK2 : BuildType({
    name = "🐧 Compiler Dist (local build cache with K2)"
    ...
    params {
        ...
        param("gradleParameters", "%globalGradleParameters% -Pkotlin.build.jar.compression=false -Pkotlin.build.isObsoleteJdkOverrideEnabled=true -Pkotlin.build.useFir=true")
    ...
    requirements {
        ...
        contains("system.cloud.profile_id", "gradle-daemon")
