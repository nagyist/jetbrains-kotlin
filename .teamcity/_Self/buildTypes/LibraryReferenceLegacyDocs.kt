...
import KotlinNative.buildTypes.KotlinNativeDist_linux_x64_DIST
...
object LibraryReferenceLegacyDocs : BuildType({
    ...
    params {
        ...
        param("konanVersion", "${KotlinNativeDist_linux_x64_DIST.depParamRefs["konanVersion"]}")
    ...
    dependencies {
        ...
        dependency(KotlinNative.buildTypes.KotlinNativeDist_linux_x64_DIST) {
            ...
            artifacts {
                artifactRules = "kotlin-native-linux-x86_64-%konanVersion%.tar.gz!kotlin-native-linux-x86_64-%konanVersion%/klib/**=>%system.kotlinNativeDistDir%/klib"
            }
        }
    }
