...
object GradleIntegrationTestsOtherGradleKotlintests_LINUX : BuildType({
    ...
    steps {
        ...
        gradle {
            ...
            tasks = ":kotlin-gradle-plugin-integration-tests:kgpOtherTests"
            buildFile = "build.gradle.kts"
            workingDir = "%teamcity.build.checkoutDir%/kotlin"
    ...
    dependencies {
        ...
        dependency(KotlinNative.buildTypes.KotlinNativeDist_linux_x64_BUNDLE) {
            ...
            artifacts {
                ...
                artifactRules = """
                    +:kotlin-native-linux-x86_64-${BuildNumber.depParamRefs.buildNumber}.tar.gz!** => %teamcity.build.checkoutDir%/kotlin/.kotlin/konan-for-gradle-tests
                    +:kotlin-native-prebuilt-linux-x86_64-${BuildNumber.depParamRefs.buildNumber}.tar.gz!** => %teamcity.build.checkoutDir%/kotlin/.kotlin/konan-for-gradle-tests
                """.trimIndent()
            }
        }
    }
