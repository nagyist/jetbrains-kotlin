...
object GradleIntegrationTestsMPPAndroidNative_LINUX : BuildType({
    name = "🐧 Gradle Integration Tests MPP Android Native (Linux)"
    ...
    steps {
        ...
        gradle {
            ...
            tasks = ":kotlin-gradle-plugin-integration-tests:test"
            buildFile = "build.gradle.kts"
            workingDir = "%teamcity.build.checkoutDir%/kotlin"
