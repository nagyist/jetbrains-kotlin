...
object AwsSdkSmithyK2 : BuildType({
    name = "🐧 [Project] AWS SDK + Smithy with K2"
    ...
    params {
        param("docker.image", "amazoncorretto:8")
    ...
    vcs {
        root(UserProjectsK2.vcsRoots.AwsSdkSmithyK2VCS, "+:. => user-project")
        root(_Self.vcsRoots.CommunityProjectPluginVCS, "+:. => community-project-plugin")
        root(DslContext.settingsRoot, "+:. => kotlin")
        root(UserProjectsK2.vcsRoots.SmithyK2VCS, "+:. => smithy-kotlin_mpp")
    }
    ...
    steps {
        gradle {
            ...
            workingDir = "smithy-kotlin_mpp"
            gradleParams = """
                -x test -x allTests -x jvmTest
                                        --stacktrace --info
        ...
        gradle {
            name = "Build Aws Sdk"
            tasks = "build publishToMavenLocal testAllProtocols"
            buildFile = "build.gradle.kts"
