...
object MultiplatformSettingsK2 : BuildType({
    name = "🍏ᵐ [Project] Multiplatform settings with K2"
    ...
    vcs {
        root(UserProjectsK2.vcsRoots.MultiplatformSettingsK2VCS, "+:. => user-project")
    ...
    steps {
        ...
        script {
            ...
            scriptContent = """
                ...
                echo "org.gradle.java.home=%env.JDK_17_0%" >> buildSrc/gradle.properties
                echo "kotlin_version=${BuildNumber.depParamRefs["deployVersion"]}" >> buildSrc/gradle.properties
                echo "kotlin_repo_url=%kotlin.artifacts.repository%" >> buildSrc/gradle.properties
                echo "kotlin.experimental.tryK2=true" >> buildSrc/gradle.properties
                echo "kotlin.native.home=%user.project.kotlin.native.home%" >> buildSrc/gradle.properties
            """.trimIndent()
        }
        gradle {
