...
object KspPlaygroundK2 : BuildType({
    name = "🐧 [Project] KSP playground with K2"
    ...
    vcs {
        root(UserProjectsK2.vcsRoots.KspK2VCS, "+:. => user-project")
    ...
    steps {
        gradle {
            ...
            gradleParams = """
                ...
                -Pkotlin_version=${BuildNumber.depParamRefs.buildNumber}
                -PkotlinBaseVersion=${BuildNumber.depParamRefs.buildNumber}
        ...
        gradle {
            ...
            tasks = "build"
            buildFile = "build.gradle.kts"
            workingDir = "user-project/examples/playground"
            gradleParams = """
                --stacktrace --info
                -Pkotlin_repo_url=%kotlin.artifacts.repository%
                -Pkotlin_version=${BuildNumber.depParamRefs.buildNumber}
