...
fun <T> memberProperty(name: String, owner: KClassImpl<T>): KMemberPropertyImpl<T, Any?> =
        KMemberPropertyImpl<T, Any?>(name, owner)

fun <T> mutableMemberProperty(name: String, owner: KClassImpl<T>): KMutableMemberPropertyImpl<T, Any?> =
