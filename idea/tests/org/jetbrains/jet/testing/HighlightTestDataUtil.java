...
public class HighlightTestDataUtil {
    public static String getTextWithTags(List<LineMarkerInfo> lineMarkers, boolean withDescription, String text) {
        ...
        return placeTagsInText(text, lineMarkerPoints);
    }

    public static String getTextWithTags(List<HighlightInfo> highlights, String text) {
        ...
        return placeTagsInText(text, highlightPoints);
    }

    private static String placeTagsInText(String text, List<? extends HighlightTag> tags) {
